...
function buildMatchesTable(matchesData) {
    ...
    for (index = 0; index < numOfMatchups; ++index) {
        ...
        //table.innerHTML+= "<td>";
        $("#matchups_tableNew").append("<td><button onClick=\"ssss\">");
        ...
        $("#matchups_tableNew").append(text + "</button></td>");
        ...
        //table.innerHTML+= "</td>";
        $("#matchups_tableNew").append(text + "</button></td>");
        $("#matchups_tableNew").append("<td>" + matchesData[index]["userScore"]);
        $("#matchups_tableNew").append("</td><td></td><td></td></tr></table>");
